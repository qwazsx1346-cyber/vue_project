<script setup>
let loading = true;
const parent = 'fruits'; //한개는 문자열, 여러개는 문자열보다는 배열로 처리하는것이 나음
const child = 'item';
/* class 바인딩과 배열의 조합은 배열의 아이템이 무조건 추가가 되지만
...
const visible = { fruit: true, abc: true };
const hidden = { fruit: false, abc: false };
